...
Product data is fetched from [FakeStoreAPI](https://fakestoreapi.com/)
...
Libraries are shareable across libraries and applications. They can be imported from `@ecommerce-monorepo-nx-test/mylib`.
